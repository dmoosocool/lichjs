/*
 * @Author: DM
 * @Date: 2021-12-31 17:53:32
 * @LastEditors: DM
 * @LastEditTime: 2021-12-31 20:11:48
 * @Descriptions:
 * @FilePath: /lich/packages/virtual-dom/src/core/init.ts
 */
...
function isElement(
  ...
  return api.isElement(vnode as Element);
}
...
function isDocumentFragment(
  ...
  return api.isDocumentFragment!(vnode as DocumentFragment);
}
...
export function init(
  ...
  function createElm(vnode: VNode, insertedVnodeQueue: VNodeQueue): Node {
    ...
    if (sel === '!') {
      ...
      if (undefined !== children && isArray(children)) {
